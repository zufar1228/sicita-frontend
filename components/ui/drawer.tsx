...
// 1. Perubahan pada DrawerOverlay
...
// 2. Perubahan pada DrawerContent dan Handle
  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          // Menambahkan shadow-neumorphic dan menghapus semua border
          "group/drawer-content bg-background fixed z-50 flex h-auto flex-col shadow-neumorphic",
          // Menghapus border-b dari sini
        ...
        {...props}
      >
        {/* Mengubah handle menjadi lekukan inset */}
        <div className="mx-auto mt-4 h-2 w-[100px] shrink-0 rounded-full bg-transparent shadow-neumorphic-inset" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  );
...
/* ================================================================== */
/* Komponen di bawah ini tidak memerlukan perubahan visual.           */
/* ================================================================== */
